...
namespace Scanning.Touch
{
    public class ScanningService : ScanningServiceBase, IScanningService, IScanSuccessCallback
    {
        ...
        public override async Task BeginPreviewAsync(object preview)
        {
            ...
            if (!(preview is UINavigationController)) return;
            _Scanner = new Scanner((UINavigationController)preview);
            _Scanner.closeScannerOnDecode = true;
        }
